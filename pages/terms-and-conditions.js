...
export default function TermsAndConditions() {
  return (
    <Layout>
      {/* <Head>
        <title>Terms and Conditions | Froshital</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:url" content="https://froshital.com/terms-and-conditions" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Terms and Conditions | Froshital"
        />
        <meta
      ...
      <section className="mx-auto w-11/12  md:w-10/12 2xl:w-auto 2xl:max-w-7xl">
        <div className="prose">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to FROSHITAL HEALTHCARE PRIVATE
                LIMITED, H. NO. 10 THIRD FLOOR, OLD DOUBLE STOREY LAJPAT NAGAR 4
                DELHI South Delhi DL 110024.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Froshital, accessible from{" "}
                <a
                  href="https://froshital.com/"
          ...
          <ul>
            <li>
              <p>By email: Contact@froshital.com</p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                By mail: H. NO. 10 THIRD FLOOR, OLD DOUBLE STOREY LAJPAT NAGAR 4
                DELHI South Delhi DL 110024
              </p>
            </li>
          </ul>
